    ...
    size_t output_stride) XNN_DISABLE_TSAN
{
  ...
  do {
    ...
    for (; c >= 16 * sizeof(float); c -= 16 * sizeof(float)) {
      ...
      v128_t vacc0x89AB = wasm_f32x4_max(vi0x89AB, vzero);
      vi0x89AB = wasm_i32x4_min(vi0x89AB, vzero);
      v128_t vacc0xCDEF = wasm_f32x4_max(vi0xCDEF, vzero);
      ...
      v128_t vacc1x89AB = wasm_f32x4_max(vi1x89AB, vzero);
      vi1x89AB = wasm_i32x4_min(vi1x89AB, vzero);
      v128_t vacc1xCDEF = wasm_f32x4_max(vi1xCDEF, vzero);
      vi1xCDEF = wasm_i32x4_min(vi1xCDEF, vzero);
      v128_t vacc2x0123 = wasm_f32x4_max(vi2x0123, vzero);
      vi2x0123 = wasm_i32x4_min(vi2x0123, vzero);
      v128_t vacc2x4567 = wasm_f32x4_max(vi2x4567, vzero);
      vi2x4567 = wasm_i32x4_min(vi2x4567, vzero);
      v128_t vacc2x89AB = wasm_f32x4_max(vi2x89AB, vzero);
      vi2x89AB = wasm_i32x4_min(vi2x89AB, vzero);
      v128_t vacc2xCDEF = wasm_f32x4_max(vi2xCDEF, vzero);
      vi2xCDEF = wasm_i32x4_min(vi2xCDEF, vzero);
      v128_t vacc3x0123 = wasm_f32x4_max(vi3x0123, vzero);
      vi3x0123 = wasm_i32x4_min(vi3x0123, vzero);
      v128_t vacc3x4567 = wasm_f32x4_max(vi3x4567, vzero);
      vi3x4567 = wasm_i32x4_min(vi3x4567, vzero);
      v128_t vacc3x89AB = wasm_f32x4_max(vi3x89AB, vzero);
      vi3x89AB = wasm_i32x4_min(vi3x89AB, vzero);
      v128_t vacc3xCDEF = wasm_f32x4_max(vi3xCDEF, vzero);
